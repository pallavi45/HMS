            ...
            <div class="page-heading">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    <h1>Donate Blood</h1>
                    <p><strong>Blood</strong>donation.....</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form id="contact" action="donordetails.php" method="post">
                      <div class="row">
                        <div class="col-md-6">
                          <fieldset>
                        ...
                        <div class="col-12">
                          <textarea name="demomessage" id="demo-message" placeholder="Enter your message/feedback" rows="6"></textarea>
                        </div>
                        <div class="col-md-12">
